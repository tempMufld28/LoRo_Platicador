...
public abstract class Hilt_UsbEventReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((UsbEventReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectUsbEventReceiver(UnsafeCasts.<UsbEventReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
